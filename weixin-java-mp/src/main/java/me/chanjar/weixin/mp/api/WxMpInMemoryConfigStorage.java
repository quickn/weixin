...
public class WxMpInMemoryConfigStorage implements WxMpConfigStorage {
    ...
    @Override
    public synchronized void updateAccessToken(WxAccessToken accessToken, String... authorizerAppid) {
        updateAccessToken(accessToken.getAccessToken(), accessToken.getExpiresIn(), accessToken.getAuthorizer_appid());
    }
    ...
    @Override
    public void updateRefreshTokenKey(String accessToken, int expiresInSeconds, String authorizerAppid) {
    ...
    @Override
    public boolean autoRefreshToken(String... accessToken) {
        return true;
    }
