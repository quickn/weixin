...
public interface WxMpService {
     ...
     */
    String getAccessToken(String ... authorizerAppid) throws WxErrorException;
     ...
     */
    String getAccessToken(boolean forceRefresh, String ... authorizerAppid) throws WxErrorException;

    /**
     * 获得jsapi_ticket,不强制刷新jsapi_ticket
     *
     */
    String getJsapiTicket(final String ... authorizerAppid) throws WxErrorException;
     ...
     * @param forceRefresh 强制刷新
     */
    String getJsapiTicket(boolean forceRefresh,final String ... authorizerAppid) throws WxErrorException;
     ...
     * </pre>
     */
    WxJsapiSignature createJsapiSignature(String url,final String ... authorizerAppid) throws WxErrorException;
     ...
     * </pre>
     */
    WxMpOAuth2AccessToken oauth2getAccessToken(String code,String ... authorizerAppid) throws WxErrorException;
     ...
     * </pre>
     */
    WxMpOAuth2AccessToken oauth2refreshAccessToken(String refreshToken,String ... authorizerAppid) throws WxErrorException;
     ...
     */
    String get(String url, String queryParam,final String... authorizerAppid) throws WxErrorException;

    /**
     * 当本Service没有实现某个API的时候，可以用这个，针对所有微信API中的POST请求
     */
    String post(String url, String postData,final String... authorizerAppid) throws WxErrorException;
     ...
     * </pre>
     */
    <T, E> T execute(RequestExecutor<T, E> executor, String uri, E data,final String... authorizerAppid) throws WxErrorException;
     ...
     * }
     */
    String componentAccessTokenGet() throws WxErrorException;
     ...
     * }
     */
    String preAuthCode() throws WxErrorException;


    String authorizerRefreshTokenGet(String component_appid, String authorizer_appid);
    boolean authorizerTokenUpdate(String authorizer_access_token, String authorizer_refresh_token,String  authorizer_appid, String component_appid);
}
