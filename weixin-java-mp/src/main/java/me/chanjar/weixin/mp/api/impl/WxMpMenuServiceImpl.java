...
public class WxMpMenuServiceImpl implements WxMpMenuService {
  ...
  @Override
  public String menuCreate(WxMenu menu,String... appid) throws WxErrorException {
    ...
    String result = this.wxMpService.post(url, menuJson,appid);
  ...
  @Override
  public String menuCreate(String json,String... appid) throws WxErrorException {
    ...
    String result = this.wxMpService.post(url, json,appid);
    if (jsonObject.get("matchrule") != null) {
  ...
  @Override
  public void menuDelete(String menuId,String... appid) throws WxErrorException {
    String url = API_URL_PREFIX + "/delconditional";
    JsonObject jsonObject = new JsonObject();
    jsonObject.addProperty("menuid", menuId);
    String result = this.wxMpService.post(url, jsonObject.toString(),appid);
  ...
  public WxMpMenu menuGet(String... appid) throws WxErrorException {
    ...
    try {
      String resultContent = this.wxMpService.get(url, null,appid);
  ...
  @Override
  public WxMenu menuTryMatch(String userid,String... appid) throws WxErrorException {
    String url = API_URL_PREFIX + "/trymatch";
    JsonObject jsonObject = new JsonObject();
    jsonObject.addProperty("user_id", userid);
    try {
      String resultContent = this.wxMpService.post(url, jsonObject.toString(),appid);
