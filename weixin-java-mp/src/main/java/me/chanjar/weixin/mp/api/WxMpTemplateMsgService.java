...
public interface WxMpTemplateMsgService {
     ...
     * @return 是否成功
     */
    boolean setIndustry(WxMpTemplateIndustry wxMpIndustry, String ... appid) throws WxErrorException;
     ...
     * @return 消息Id
     */
    String sendTemplateMsg(WxMpTemplateMessage templateMessage, String ... appid) throws WxErrorException;
     ...
     */
    String addTemplate(String shortTemplateId, String ... appid) throws WxErrorException;
     ...
     */
    boolean delPrivateTemplate(String templateId, String... app) throws WxErrorException;
}
