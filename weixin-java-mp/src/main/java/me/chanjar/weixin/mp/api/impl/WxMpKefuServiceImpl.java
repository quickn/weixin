...
public class WxMpKefuServiceImpl implements WxMpKefuService {
  ...
  @Override
  public boolean sendKefuMessage(WxMpKefuMessage message,String... authorizerAppid )
      throws WxErrorException {
    String url = "https://api.weixin.qq.com/cgi-bin/message/custom/send";
    String responseContent = this.wxMpService.post(url, message.toJson(),authorizerAppid);
    return responseContent != null;
  }

  @Override
  public WxMpKfList kfList(String... authorizerAppid) throws WxErrorException {
    String url = API_URL_PREFIX_WITH_CGI_BIN + "/getkflist";
    String responseContent = this.wxMpService.get(url, null,authorizerAppid);
    return WxMpKfList.fromJson(responseContent);
  }

  @Override
  public WxMpKfOnlineList kfOnlineList(String... authorizerAppid) throws WxErrorException {
  ...
  @Override
  public boolean kfAccountAdd(WxMpKfAccountRequest request,String... authorizerAppid)
      throws WxErrorException {
    String url = API_URL_PREFIX + "/kfaccount/add";
    String responseContent = this.wxMpService.post(url, request.toJson(),authorizerAppid);
    return responseContent != null;
  }

  @Override
  public boolean kfAccountUpdate(WxMpKfAccountRequest request,String... authorizerAppid)
      throws WxErrorException {
  ...
  @Override
  public boolean kfAccountInviteWorker(WxMpKfAccountRequest request,String... authorizerAppid) throws WxErrorException {
  ...
  @Override
  public boolean kfAccountUploadHeadImg(String kfAccount, File imgFile,String... authorizerAppid)
      throws WxErrorException {
    ...
    WxMediaUploadResult responseContent = this.wxMpService
        .execute(new MediaUploadRequestExecutor(), url, imgFile,authorizerAppid);
    return responseContent != null;
  }

  @Override
  public boolean kfAccountDel(String kfAccount,String... authorizerAppid) throws WxErrorException {
  ...
  @Override
  public boolean kfSessionCreate(String openid, String kfAccount,String... authorizerAppid)
      throws WxErrorException {
  ...
  @Override
  public boolean kfSessionClose(String openid, String kfAccount,String... authorizerAppid)
      throws WxErrorException {
    WxMpKfSessionRequest request = new WxMpKfSessionRequest(kfAccount, openid);
  ...
  @Override
  public WxMpKfSessionGetResult kfSessionGet(String openid,String... authorizerAppid)
      throws WxErrorException {
  ...
  @Override
  public WxMpKfSessionList kfSessionList(String kfAccount,String... authorizerAppid)
      throws WxErrorException {
  ...
  @Override
  public WxMpKfSessionWaitCaseList kfSessionGetWaitCase(String... authorizerAppid)
      throws WxErrorException {
  ...
  @Override
  public WxMpKfMsgList kfMsgList(Date startTime, Date endTime, Long msgId, Integer number,String... authorizerAppid) throws WxErrorException {
    if(number > 10000){
    ...
    String responseContent = this.wxMpService.post(url, param.toString(),authorizerAppid);

    return WxMpKfMsgList.fromJson(responseContent);
  }

  @Override
  public WxMpKfMsgList kfMsgList(Date startTime, Date endTime,String... authorizerAppid) throws WxErrorException {
    int number = 10000;
