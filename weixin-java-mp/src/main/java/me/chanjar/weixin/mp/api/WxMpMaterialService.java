...
public interface WxMpMaterialService {
   ...
   */
  WxMediaUploadResult mediaUpload(String mediaType, File file,String ... authorizerAppid) throws WxErrorException;
   ...
   * @throws WxErrorException
   * @see #mediaUpload(java.lang.String, java.io.File ,String[])
   */
  WxMediaUploadResult mediaUpload(String mediaType, String fileType, InputStream inputStream,String ... authorizerAppid) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  File mediaDownload(String media_id,String ... authorizerAppid) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  WxMediaImgUploadResult mediaImgUpload(File file,String ... authorizerAppid) throws WxErrorException;
   ...
   */
  WxMpMaterialUploadResult materialFileUpload(String mediaType, WxMpMaterial material,String ... authorizerAppid) throws WxErrorException;
   ...
   */
  WxMpMaterialUploadResult materialNewsUpload(WxMpMaterialNews news,String ... authorizerAppid) throws WxErrorException;
   ...
   */
  InputStream materialImageOrVoiceDownload(String mediaId,String ... authorizerAppid) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WxMpMaterialVideoInfoResult materialVideoInfo(String mediaId,String ... authorizerAppid) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WxMpMaterialNews materialNewsInfo(String mediaId,String ... authorizerAppid) throws WxErrorException;
   ...
   */
  boolean materialNewsUpdate(WxMpMaterialArticleUpdate wxMpMaterialArticleUpdate,String ... authorizerAppid) throws WxErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  boolean materialDelete(String mediaId,String ... authorizerAppid) throws WxErrorException;
   ...
   * </pre>
   */
  WxMpMaterialCountResult materialCount(String ... authorizerAppid) throws WxErrorException;
   ...
   */
  WxMpMaterialNewsBatchGetResult materialNewsBatchGet(int offset, int count,String ... authorizerAppid) throws WxErrorException;
   ...
   * @param count  返回素材的数量，取值在1到20之间
   */
  WxMpMaterialFileBatchGetResult materialFileBatchGet(String type, int offset, int count,String ... authorizerAppid) throws WxErrorException;
